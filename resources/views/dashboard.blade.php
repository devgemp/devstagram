...
@section('contenido')
                ...
                <div class="flex items-center gap-2 mb-3">
                    ...
                    @auth
                        @if ($user->id === auth()->user()->id)
                            <a href="{{ route('perfil.index') }}" class="text-gray-500 hover:text-gray-700 transition-colors cursor-pointer">
    ...
    <section class="container mx-auto mt-10">
        ...
        {{-- @if ($user->posts->count()) Accediendo a los posts a traves de una relacion --}}
        @if ($posts->count())
                    ...
                    <div>
                        <a href="{{ route('posts.show', ['post' => $post, 'user' => $user]) }}">
                            <img
                                ...
                                class="rounded-xl shadow-sm p-1"
                            >
                        </a>
                    </div>
                @endforeach
